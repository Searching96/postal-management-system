        ...
        <div className="flex h-screen">
          ...
          <aside className="w-64 bg-muted/30 border-r flex flex-col">
            ...
            <div className="p-6 border-b">
              ...
              <div className="text-sm text-muted-foreground mt-1">Dành cho khách hàng</div>
            </div>
                ...
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="w-full justify-start gap-3 h-auto p-3">
                    ...
                    <div className="flex flex-col items-start text-left">
                      ...
                      <div className="text-xs text-muted-foreground">{role ?? "Khách hàng"}</div>
                    </div>
                  </Button>
                </DropdownMenuTrigger>
          ...
          <div className="px-4 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-xs">
              <div className="text-right leading-tight">
                ...
                <div className="text-muted-foreground">{role ?? "Khách hàng"}</div>
              </div>
            </div>
          </div>
          {title && (
