...
export function ConfirmPickup() {
  return (
    <MobileShell title="Xác nhận đã lấy hàng" userName="Nguyễn Văn A" role="Bưu tá">
...
export function ConfirmDeliverySuccess() {
  return (
    <MobileShell title="Xác nhận giao thành công" userName="Nguyễn Văn A" role="Bưu tá">
      <div className="space-y-4">
...
export function ReportDeliveryFailure() {
  return (
    <MobileShell title="Báo cáo giao thất bại" userName="Nguyễn Văn A" role="Bưu tá">
      <div className="space-y-4">
