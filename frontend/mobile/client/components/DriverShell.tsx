...
const tabs = [
  ...
  { to: "/delivery-driver/pickup-confirm", label: "Đã lấy", icon: ClipboardCheck },
  { to: "/delivery-driver/deliver-success", label: "Đã giao", icon: CheckCircle2 },
  { to: "/delivery-driver/deliver-fail", label: "Thất bại", icon: XCircle },
];
