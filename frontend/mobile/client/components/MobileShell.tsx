...
const tabs = [
  ...
  { to: "/pickup", label: "Lấy hàng", icon: PackagePlus },
  { to: "/pickup-confirm", label: "Đã lấy", icon: ClipboardCheck },
  { to: "/deliver-success", label: "Đã giao", icon: CheckCircle2 },
  { to: "/deliver-fail", label: "Thất bại", icon: XCircle },
  { to: "/complaint", label: "Khiếu nại", icon: MessageSquareMore },
];

export default function MobileShell({ title, children, userName, role }: MobileShellProps) {
