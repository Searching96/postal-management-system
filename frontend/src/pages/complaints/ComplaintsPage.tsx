...
const MOCK_COMPLAINTS: Complaint[] = [
    {
        ...
        status: "PENDING",
        description: "Hàng hỏa tốc nhưng lại giao hàng trễ 3 ngày so với cam kết, không thể chấp nhận được",
...
const HistoryModal = ({ complaint, onClose }: { complaint: Complaint; onClose: () => void }) => {
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
                <div className="flex items-center justify-between p-6 border-b">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Chi tiết hành trình và người chịu trách nhiệm</p>
                    </div>
                                ...
                                <div className="bg-gray-50 rounded-lg p-4 border border-gray-100 hover:border-primary-200 transition-colors">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm mt-3 pt-3 border-t border-gray-200">
                                        ...
                                        <div className="flex items-start gap-2 text-gray-600">
                                            ...
                                            <div className="min-w-0"> {/* Ensure wrapping here too */}
                                                <span className="block text-xs text-gray-400 uppercase font-semibold">Địa điểm</span>
                                        ...
                                        <div className="flex items-start gap-2 text-gray-600">
                                            ...
                                            <div className="min-w-0"> {/* Ensure wrapping here too */}
                                                <span className="block text-xs text-gray-400 uppercase font-semibold">Người xử lý</span>
                                                <div className="font-medium text-gray-900 break-words">{item.handlerName}</div>
